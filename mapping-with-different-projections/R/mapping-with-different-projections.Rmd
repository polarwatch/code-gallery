...
> contact \| Sunny Hospital (sun.bak-hospital@noaa.gov)<br/>
...
seaice_url <- 'https://polarwatch.noaa.gov/erddap/griddap/nsidcG02202v4nhmday.nc?cdr_seaice_conc_monthly'
sea_ice_data_nc <- download.file(seaice_url, destfile="../data/sea_ice_data.nc", mode='wb')

# file open
seaice <- nc_open('sea_ice_data.nc')
